...
/// Create the configuration for a UR3 robot
pub fn create_config() -> ROS2RobotConfig {
    ...
    // Configuration for publishing UR3 tool speed commands.
    ...
    let glb_path = default_model_path!("ur3");

    ROS2RobotConfig {
        model_family: Some("ur3".to_string()),
        domain_id: None,
        topics,
