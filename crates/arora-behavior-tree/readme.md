...
It can be:
- a serialized [`Value`, like defined in `arora-schema`](../arora-schema/readme.md#value),
...
before calling [`arora_dispatch_indirect`](../arora/readme.md#calling-module-functions).
...
if they are mentioned in the [module function description](../arora-schema/readme.md#value).
