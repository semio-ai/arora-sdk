...
Command-line tool for generating language-specific build-files, exporting types, and exporting modules. arora-module-cli interfaces with language-specific executables to generate code; please see those crates for more information.
