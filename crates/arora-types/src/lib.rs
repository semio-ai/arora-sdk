...
// Make this crate reachable as `arora_types` from within itself, so the code
// generated by `#[derive(AroraType)]` resolves the same `arora_types::…` paths
// whether it expands here or in a downstream crate.
extern crate self as arora_types;

pub use arora_type::AroraType;
#[cfg(feature = "derive")]
pub use arora_types_derive::AroraType;
...
// Re-exported as `arora_types::Uuid` for the code `#[derive(AroraType)]`
