...
//!   with `Value` as the data model. [`to_value`]/[`from_value`] derive struct
//!   ids by hashing names; [`to_value_seeded`]/[`from_value_seeded`], given a
//!   declared [`low::Type`], take the ids from the *type* instead.
