...
in a layout specified for [registries](https://github.com/semio-ai/arora-sdk).

In this project, `<project>/crates/arora-behavior-tree-types-yaml`
is often used as an `--include` option to CLI tools such as
[`arora-cli`](https://github.com/semio-ai/arora-sdk)
or [`arora-module-cli`](https://github.com/semio-ai/arora-sdk).
