...
use ast::{TranslationUnit, PreprocessorDirective, Namespace, Declaration, FunctionPrototype, TypeRef, Parameter, NewLine, IncludeStyle};
use clap::Parser;
...
use arora_schema::{
  ...
  module::low::{ImportSymbol, ExportSymbol, Header}
};
        ...
        for parameter in f.parameters.iter() {
          parameters.push(Parameter {
            ...
            type_ref: TypeRef {
              ...
              reference: !PRIMITIVE_IDS.contains(&parameter.ty_id),
